...
import { owc100EvenOddImageData } from "@/app/all-content/products/owc100EvenOddImageData";
  ...
  return (
    <>
      ...
      <div className="d-flex align-items-center gap-2 flex-wrap px-5 py-5">
                  ...
                  <div className="d-flex justify-between align-items-center">
                    <div>END OWC 100</div> <div><AiOutlineRight /></div>
                  </div>
                </div>
        <div className="row">
          <div className="col-lg-9 py-5">
            <div className="position-relative">
              <img
                src="/images/OWC_100_1440x678.jpg"
                alt="Product Image"
                className="img-fluid"
              />
              <div className="card-position">
                <div className=" p-4">
                  <strong className=" m-0 p-0">END OWC 100</strong>
                </div>
              </div>
            </div>
            <Box sx={{ width: "100%" }}>
              ...
              <Overview EvenOddImagesData={owc100EvenOddImageData} />
              </TabPanel>
