...
import { owc50EvenOddImageData } from "@/app/all-content/products/owc50EvenOddImageData";
    ...
    <>
      <div className="final-product-page-container">
        {/* <div className="d-flex align-items-center gap-2 px-5 pt-5">
          ...
          <p>
            <span>END OWC 50</span> <AiOutlineRight />
          </p>
        </div> */}
           <div className="d-flex align-items-center gap-2 flex-wrap px-5 py-5">
                  ...
                  <div className="d-flex justify-between align-items-center">
                    <div>Organic Waste Composter</div> <div><AiOutlineRight /></div>
                  </div>
                  <div className="d-flex justify-between align-items-center">
                    <div>END OWC 50</div> <div><AiOutlineRight /></div>
                  </div>
                </div>
        <div className="row">
          <div className="col-lg-9 py-5">
            <div className="position-relative">
              <img
                src="/images/OWC_50_1440x678.jpg"
                alt="Product Image"
                className="img-fluid"
              />
              <div className="card-position">
                <div className=" p-4">
                  <strong className=" m-0 p-0">END OWC 50</strong>
                </div>
              </div>
            </div>
            <Box sx={{ width: "100%" }}>
              ...
              <Overview EvenOddImagesData={owc50EvenOddImageData} />
              </TabPanel>
