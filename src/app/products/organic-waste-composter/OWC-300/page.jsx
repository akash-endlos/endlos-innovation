...
import { owc300EvenOddImageData } from "@/app/all-content/products/owc300EvenOddImageData";
  ...
  return (
    <>
      ...
      <div className="d-flex align-items-center gap-2 flex-wrap px-5 py-5">
                  ...
                  <div className="d-flex justify-between align-items-center">
                    <div>END OWC 300</div> <div><AiOutlineRight /></div>
                  </div>
                </div>
        <div className="row">
          <div className="col-lg-9 py-5">
            ...
            <Box sx={{ width: "100%" }}>
              ...
              <Overview EvenOddImagesData={owc300EvenOddImageData} />
              </TabPanel>
