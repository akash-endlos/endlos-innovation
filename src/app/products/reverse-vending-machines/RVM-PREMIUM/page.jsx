...
import { rvmPremiumVideo } from "@/app/all-content/productVideoContainer/rvmVideo";
  ...
  return (
    <>
      ...
      <div className="d-flex align-items-center gap-2 flex-wrap px-5 py-5">
                  ...
                  <div className="d-flex justify-between align-items-center">
                    <div>RVM PREMIUM</div> <div><AiOutlineRight /></div>
                  </div>
                </div>
        <div className="row">
          <div className="col-lg-9 py-5">
            ...
            <Box sx={{ width: "100%" }}>
              ...
              <TabPanel value={value} index={0}>
                <Overview productVideos={rvmPremiumVideo} EvenOddImagesData={rvmPremiumEvenOddImageData} />
              </TabPanel>
