          ...
          <div className="col-xl-6 col-lg-12">
            <div>
              ...
              <p>
                ...
                lower power classes of the fiber laser (up to 1 kW) are
                optimally suited for laser precision cutting and welding, the
                higher power classes (over 1 kW) shine when it comes to wobble
                welding.
              </p>
            </div>
